...
charger_hours = col1.number_input('Hours:', min_value=0, value=0)
charger_minutes = col2.number_input('Minutes:', min_value=0, max_value=59, value=0)
...
working_hours = col3.number_input('Hours:', min_value=0, value=0)
working_minutes = col4.number_input('Minutes:', min_value=0, max_value=59, value=0)
