...
cost = st.text_input("The cost per kilowatt-hour in pesos:")
...
if A1N:
    ...
    A1B = st.number_input("How many days in a month do you use this?(1-31)")
...
# ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                            if ask8 == 1:  # add app9 (8th line)
                                A9N = str(input("Name of 9th appliance: "))
                                if A9N:
                                    A9M = st.number_input(
